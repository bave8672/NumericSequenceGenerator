...
<html>
    <head>
        ...
        <title>DalekJS - Documentation - Browser - Internet Explorer</title>
        <meta name="description" content="DalekJS - Documentation - Browser - Internet Explorer">
    ...
    <body data-buildtime="Monday, March 10th, 2014, 7:54:54 PM"><!--
        ...
        --><div class="grid"><!--
            ...
            --><header class="grid__item one-whole"><!--
                --><nav role="select"><!--
                    ...
                    --></select><!--
                --></nav><!--
            --></header><div class="grid__item one-whole"><div class="grid__item one-whole"><h1 class="topic">InternetExplorer</h1><p> This module is a browser plugin for <a href="//github.com/dalekjs/dalek">DalekJS</a>.
 It provides all a WebDriverServer &amp; browser launcher for Internet Explorer.</p>

<p> The browser plugin can be installed with the following command:</p>

<p> <pre><code class="language-bash">
 $ npm install dalek-browser-ie --save-dev
 </code></pre></p>

<p> You can use the browser plugin by adding a config option to the your Dalekfile</p>

<p> <pre><code class="language-javascript">
 &quot;browsers&quot;: [&quot;IE&quot;]
 </code></pre></p>

<p> Or you can tell Dalek that it should test in this browser via the command line:</p>

<p> <pre><code class="language-bash">
 $ dalek mytest.js -b IE
 </code></pre></p>

<p> The Webdriver Server tries to open Port 5555 by default,
 if this port is blocked, it tries to use a port between 5555 &amp; 5564
 You can specifiy a different port from within your <a href="/pages/config.html">Dalekfile</a> like so:</p>
...
<p> It is also possible to specify a range of ports:</p>
